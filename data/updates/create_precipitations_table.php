...
class CreatePrecipitationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cnesmeteo_data_precipitations', function($table)
        {
            $table->engine = 'InnoDB';
        ...
        // Foreign keys
        Schema::table('cnesmeteo_data_precipitations', function($table)
        {
    ...
    {
        Schema::drop('cnesmeteo_data_precipitations');
    }
