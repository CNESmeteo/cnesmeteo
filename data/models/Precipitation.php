...
class Precipitation extends MeasurementsBase
{
    /**
     * @var string The database table used by the model.
     */
    protected $table = 'cnesmeteo_data_precipitations';

    protected $primaryKey = 'measurement_id'; // extends the measurement info

    protected $value_units = 'l';
     ...
     */
    public $rules = [
        'value' => 'required|numeric|min:0.0|max:500.0', // Value range (litres)
